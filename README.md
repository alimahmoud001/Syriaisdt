...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div id="Buy" class="tabcontent" style="display: block;">
                ...
                <form id="buyForm">
                    <div class="form-group">
                        <label for="buyAmount"><i class="fas fa-money-bill-wave"></i> المبلغ المراد شراءه:</label>
                        <div class="amount-converter">
                            <input type="number" id="buyAmount" step="0.01" min="1" required placeholder="أدخل المبلغ">
                    ...
                    <div class="conversion-result" id="buyConversionResult" style="display: none;">
                        <span id="buyConvertedAmount"></span>
                    </div>
                ...
                <div id="buyResult" class="result">
                    ...
                    <p>المبلغ المراد شراءه: <span id="resultBuyAmount"></span></p>
                    ...
                    <div class="send-button-container">
                        <button class="send-button" onclick="sendToTelegram('buy')">
            ...
            <div id="Sell" class="tabcontent">
                ...
                <form id="sellForm">
                    ...
                    <div class="form-group">
                        <label for="receiveCurrency"><i class="fas fa-money-check"></i> طريقة الاستلام:</label>
                    ...
                    <div class="conversion-result" id="sellConversionResult" style="display: none;">
                        <span id="sellConvertedAmount"></span>
                    </div>
                ...
                <div id="sellResult" class="result">
                    ...
                    <div class="send-button-container">
                        <button class="send-button" onclick="sendToTelegram('sell')">
                            <i class="fab fa-telegram"></i> إرسال الطلب إلى Telegram
                        </button>
                    </div>
                </div>
    ...
    <script>
        ...
        // تحويل العملة عند إدخال المبلغ
        function setupCurrencyConversion() {
            const buyAmountInput = document.getElementById('buyAmount');
            const buyCurrencySelect = document.getElementById('buyCurrency');
            const buyConversionResult = document.getElementById('buyConversionResult');
            const buyConvertedAmount = document.getElementById('buyConvertedAmount');
            ...
            function updateBuyConversion() {
                ...
                if (isNaN(amount) || amount <= 0) {
                    buyConversionResult.style.display = 'none';
                    return;
                }
                
                if (currency === 'usd') {
                    const convertedAmount = amount * exchangeRate;
                    buyConvertedAmount.textContent = `المبلغ بالليرة السورية: ${convertedAmount.toLocaleString()} SYP`;
                } else {
                    const convertedAmount = amount / exchangeRate;
                    buyConvertedAmount.textContent = `المبلغ بالدولار الأمريكي: ${convertedAmount.toFixed(2)} $`;
                }
                
                buyConversionResult.style.display = 'block';
            }
            
            buyAmountInput.addEventListener('input', updateBuyConversion);
            buyCurrencySelect.addEventListener('change', updateBuyConversion);
            
            const sellAmountInput = document.getElementById('sellAmount');
            const receiveCurrencySelect = document.getElementById('receiveCurrency');
            const sellConversionResult = document.getElementById('sellConversionResult');
            const sellConvertedAmount = document.getElementById('sellConvertedAmount');
            ...
            function updateSellConversion() {
                ...
                if (isNaN(amount) || amount <= 0) {
                    sellConversionResult.style.display = 'none';
                    return;
                }
                ...
                if (currency === 'syp') {
                    ...
                    sellConvertedAmount.textContent = `المبلغ المستلم بالليرة السورية: ${convertedAmount.toLocaleString()} SYP`;
                } else {
                    sellConvertedAmount.textContent = `المبلغ المستلم بالدولار الأمريكي: ${netAmount.toFixed(2)} $`;
                }
                
                sellConversionResult.style.display = 'block';
            }
            
            sellAmountInput.addEventListener('input', updateSellConversion);
            receiveCurrencySelect.addEventListener('change', updateSellConversion);
        }
        ...
        async function sendToTelegram(type) {
            ...
            message += `*المبلغ:* ${transactionData.amount} ${transactionData.currency === 'usd' ? '$' : 'SYP'}%0A`;
        ...
        document.getElementById('buyForm').addEventListener('submit', function(e) {
            ...
            if (currency === 'usd') {
                ...
                commissionText = (commission * exchangeRate).toLocaleString() + " SYP (" + commission.toFixed(2) + " $)";
                totalText = totalAmount.toLocaleString() + " SYP";
                amountText = amount.toLocaleString() + " SYP";
            }
            
            document.getElementById('resultBuyAmount').textContent = amountText;
        ...
        document.getElementById('sellForm').addEventListener('submit', function(e) {
            ...
            if (currency === 'usd') {
                ...
                commissionText = (commission * exchangeRate).toLocaleString() + " SYP (" + commission.toFixed(2) + " $)";
                totalText = netAmount.toLocaleString() + " SYP";
            }
            
            document.getElementById('resultSellAmount').textContent = amount.toFixed(2) + " USDT";
